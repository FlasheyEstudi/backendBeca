...
import { Asignatura } from '../../asignatura/entities/asignatura.entity'; // Asegúrate de importar Asignatura si la usas aquí
...
export class Carrera { // ¡NOMBRE DE LA CLASE CAMBIADO DE Beca_Carrera A Carrera!
  ...
  @Column({ type: 'varchar', length: 100, nullable: false }) // Asegúrate del tipo y longitud
  Nombre: string;
